<div class="container">
    <div class="row custom-flex-containervp">
        <div class="col-lg-6 col-md-6 col-xs-12 mb-1">
            <a href="{$videoplayer_url}" id="link-imagevp">
                <img title="WC" class="img-fluid" src="{$minia_url}" id="zoom-enlightvp" alt="">
            </a>         
        </div>
    ...
    <div class="row">
        <div class="col-lg-12 align-centervp text-centervp mt-2 mb-3">
            <h3 class="col-lg-9">
            {l s="Unique sur le marché de l'hygiène des WC à usage collectif, avec des milliers de références, HYGISEAT est reconnu pour son système fiable, robuste et ergonomique." mod=flvideoplayer}
            </h3>
        </div>
    </div>
</div>
